...
class NiftyBankNiftyOptionCallsPage extends StatefulWidget {
  @override
  _NiftyBankNiftyOptionCallsPageState createState() =>
      _NiftyBankNiftyOptionCallsPageState();
}

class _NiftyBankNiftyOptionCallsPageState
    extends State<NiftyBankNiftyOptionCallsPage>
  ...
  final List<String> carouselImages = [
    'assets/Nifty+Bank-Nifty-Calls.gif',
    'assets/Nifty+BankNifty_OPCalls.gif',
  ];

  final List<Map<String, dynamic>> sections = [
    {
      'heading': 'Nifty + Bank Nifty Option Calls',
      'content':
          'Looking for reliable Nifty+Bank Nifty Option Calls? Ensure seamless stock transactions with timely funds for delivery settlements. Stay updated with brokerage updates and avoid penalties by fulfilling cash calls promptly.',
      'icon': Icons.local_shipping_outlined,
      'color': LinearGradient(colors: [Color(0xFF667eea), Color(0xFF764ba2)]),
    },
    {
      'heading': 'What is Nifty+Bank Nifty Option Calls?',
      'content':
          'Nifty+Bank Nifty Option Calls are requests made by brokerage firms to their clients for funds required to settle transactions where actual delivery of shares or securities is involved. When an investor buys shares intending to take delivery, they need to pay the full purchase amount.',
    ...
    },
    {
      ...
      'content':
          'Before starting Nifty+Bank Nifty Option Calls trading, understand market fundamentals, stock selection, and timing strategies. Analyze company financials and trends, ensuring sufficient capital for long-term holding.',
    ...
    },
    {
      'heading': 'Conclusion',
      'content':
          'Nifty+Bank Nifty Option Calls trading requires a clear understanding of market dynamics and disciplined execution. With AS Research Technic, access reliable insights and customized plans to suit your investment goals.',
              ...
              children: [
                ...
                if (section['hasGif'] == true) ...[
                  ...
                  ClipRRect(
                    ...
                    child: Image.asset(
                      'assets/Why_Choose_Nifty+Bank_Nifty_OPCalls.gif',
                      fit: BoxFit.cover,
                    ),
                  ),
                ],
