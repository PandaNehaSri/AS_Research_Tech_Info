...
class PositionalMcxCallsPage extends StatefulWidget {
  @override
  _PositionalMcxCallsPageState createState() => _PositionalMcxCallsPageState();
}

class _PositionalMcxCallsPageState extends State<PositionalMcxCallsPage>
  ...
  final List<String> carouselImages = [
    'assets/Positional_MCX_CALLS.gif',
    'assets/Positional_MCX_Calls1.gif',
  ];

  final List<Map<String, dynamic>> sections = [
    {
      'heading': 'Positional Mcx Calls ',
      'content':
