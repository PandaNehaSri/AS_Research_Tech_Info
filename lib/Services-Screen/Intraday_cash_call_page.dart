...
class IntradayCashCallsPage extends StatefulWidget {
  @override
  _IntradayCashCallsPageState createState() => _IntradayCashCallsPageState();
}

class _IntradayCashCallsPageState extends State<IntradayCashCallsPage>
  ...
  final List<String> carouselImages = [
    'assets/IntradayCashCalls.jpg',
    'assets/intradaycashcalls1.jpg',
  ];

  final List<Map<String, dynamic>> sections = [
    {
      'heading': 'Intraday Cash Calls',
      'content':
          'Looking for reliable Intraday Cash Calls? Ensure seamless stock transactions with timely funds for delivery settlements. Stay updated with brokerage updates and avoid penalties by fulfilling cash calls promptly.',
      'icon': Icons.local_shipping_outlined,
      'color': LinearGradient(colors: [Color(0xFF667eea), Color(0xFF764ba2)]),
    },
    {
      'heading': 'What is Intraday Cash Calls?',
      'content':
          'Intraday Cash Calls are requests made by brokerage firms to their clients for funds required to settle transactions where actual delivery of shares or securities is involved. When an investor buys shares intending to take delivery, they need to pay the full purchase amount.',
    ...
    },
    {
      ...
      'content':
          'Before starting Intraday Cash Calls trading, understand market fundamentals, stock selection, and timing strategies. Analyze company financials and trends, ensuring sufficient capital for long-term holding.',
    ...
    },
    {
      'heading': 'Conclusion',
      'content':
          'Intraday Cash Calls trading requires a clear understanding of market dynamics and disciplined execution. With AS Research Technic, access reliable insights and customized plans to suit your investment goals.',
