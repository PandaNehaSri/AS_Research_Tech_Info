...
class NiftyBankNiftyPage extends StatefulWidget {
  @override
  _NiftyBankNiftyPageState createState() => _NiftyBankNiftyPageState();
}

class _NiftyBankNiftyPageState extends State<NiftyBankNiftyPage>
  ...
  final List<String> carouselImages = [
    'assets/NIFTY+BANK_NIFTY.jpg',
    'assets/NIFTY_BANK_NIFTY.jpg',
  ];

  final List<Map<String, dynamic>> sections = [
    {
      'heading': 'Nifty Bank Nifty ',
      'content':
          'Looking for reliable Nifty Bank Nifty ? Ensure seamless stock transactions with timely funds for delivery settlements. Stay updated with brokerage updates and avoid penalties by fulfilling cash calls promptly.',
      'icon': Icons.local_shipping_outlined,
      'color': LinearGradient(colors: [Color(0xFF667eea), Color(0xFF764ba2)]),
    },
    {
      'heading': 'What is Nifty Bank Nifty ?',
      'content':
          'Nifty Bank Nifty  are requests made by brokerage firms to their clients for funds required to settle transactions where actual delivery of shares or securities is involved. When an investor buys shares intending to take delivery, they need to pay the full purchase amount.',
    ...
    },
    {
      ...
      'content':
          'Before starting Nifty Bank Nifty  trading, understand market fundamentals, stock selection, and timing strategies. Analyze company financials and trends, ensuring sufficient capital for long-term holding.',
    ...
    },
    {
      'heading': 'Conclusion',
      'content':
          'Nifty Bank Nifty  trading requires a clear understanding of market dynamics and disciplined execution. With AS Research Technic, access reliable insights and customized plans to suit your investment goals.',
              ...
              children: [
                ...
                if (section['hasGif'] == true) ...[
                  ...
                  ClipRRect(
                    ...
                    child: Image.asset(
                      'assets/Why_Choose_NIFTY+BANK.gif',
                      fit: BoxFit.cover,
                    ),
                  ),
                ],
