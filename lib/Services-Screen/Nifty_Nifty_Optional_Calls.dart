...
class NiftyOptionalCallsPage extends StatefulWidget {
  @override
  _NiftyOptionalCallsPageState createState() => _NiftyOptionalCallsPageState();
}

class _NiftyOptionalCallsPageState extends State<NiftyOptionalCallsPage>
  ...
  final List<String> carouselImages = [
    'assets/Nifty_Nifty_optional_calls.gif',
    'assets/Nifty_Nifty_calls.gif',
  ];

  final List<Map<String, dynamic>> sections = [
    {
      'heading': 'Nifty+Nifty Optional Calls ',
      'content':
          'Looking for reliable Nifty+Nifty Optional Calls ? Ensure seamless stock transactions with timely funds for delivery settlements. Stay updated with brokerage updates and avoid penalties by fulfilling cash calls promptly.',
      'icon': Icons.local_shipping_outlined,
      'color': LinearGradient(colors: [Color(0xFF667eea), Color(0xFF764ba2)]),
    },
    {
      'heading': 'What is Nifty+Nifty Optional Calls ?',
      'content':
          'Nifty+Nifty Optional Calls  are requests made by brokerage firms to their clients for funds required to settle transactions where actual delivery of shares or securities is involved. When an investor buys shares intending to take delivery, they need to pay the full purchase amount.',
    ...
    },
    {
      ...
      'content':
          'Before starting Nifty+Nifty Optional Calls  trading, understand market fundamentals, stock selection, and timing strategies. Analyze company financials and trends, ensuring sufficient capital for long-term holding.',
    ...
    },
    {
      'heading': 'Conclusion',
      'content':
          'Nifty+Nifty Optional Calls  trading requires a clear understanding of market dynamics and disciplined execution. With AS Research Technic, access reliable insights and customized plans to suit your investment goals.',
              ...
              children: [
                ...
                if (section['hasGif'] == true) ...[
                  ...
                  ClipRRect(
                    ...
                    child: Image.asset(
                      'assets/Why_choose_nifty+nifty_optional.gif',
                      fit: BoxFit.cover,
                    ),
                  ),
                ],
