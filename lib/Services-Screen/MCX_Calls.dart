...
class MCXCallsPage extends StatefulWidget {
  @override
  _MCXCallsPageState createState() => _MCXCallsPageState();
}

class _MCXCallsPageState extends State<MCXCallsPage>
  ...
  final List<String> carouselImages = [
    'assets/MCX_Calls.gif',
    'assets/MCX_Calls_1.gif',
  ];
