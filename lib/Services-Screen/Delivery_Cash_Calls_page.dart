...
class DeliveryCashCallsPage extends StatefulWidget {
  @override
  _DeliveryCashCallsPageState createState() => _DeliveryCashCallsPageState();
}

class _DeliveryCashCallsPageState extends State<DeliveryCashCallsPage>
  ...
  final List<String> carouselImages = [
    'assets/delivery_cash_calls1.gif',
    'assets/delivery_cash_calls2.gif',
  ];

  final List<Map<String, dynamic>> sections = [
    {
      'heading': 'Delivery Cash Calls',
      'content':
          'Looking for reliable Delivery Cash Calls? Ensure seamless stock transactions with timely funds for delivery settlements. Stay updated with brokerage updates and avoid penalties by fulfilling cash calls promptly.',
      'icon': Icons.local_shipping_outlined,
      'color': LinearGradient(colors: [Color(0xFF667eea), Color(0xFF764ba2)]),
    },
    {
      'heading': 'What is Delivery Cash Calls?',
      'content':
          'Delivery Cash Calls are requests made by brokerage firms to their clients for funds required to settle transactions where actual delivery of shares or securities is involved. When an investor buys shares intending to take delivery, they need to pay the full purchase amount.',
    ...
    },
    {
      ...
      'content':
          'Before starting delivery cash calls trading, understand market fundamentals, stock selection, and timing strategies. Analyze company financials and trends, ensuring sufficient capital for long-term holding.',
    ...
    },
    {
      'heading': 'Conclusion',
      'content':
          'Delivery Cash Calls trading requires a clear understanding of market dynamics and disciplined execution. With AS Research Technic, access reliable insights and customized plans to suit your investment goals.',
              ...
              children: [
                ...
                if (section['hasGif'] == true) ...[
                  ...
                  ClipRRect(
                    ...
                    child: Image.asset(
                      'assets/delievery_choose_us.gif',
                      fit: BoxFit.cover,
                    ),
                  ),
                ],
