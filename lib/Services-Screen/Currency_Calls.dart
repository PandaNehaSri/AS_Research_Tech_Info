...
class CurrencyCallsPage extends StatefulWidget {
  @override
  _CurrencyCallsPageState createState() => _CurrencyCallsPageState();
}

class _CurrencyCallsPageState extends State<CurrencyCallsPage>
  ...
  final List<String> carouselImages = [
    'assets/Currency_Calls.gif',
    'assets/Currency_Calls1.gif',
  ];

  final List<Map<String, dynamic>> sections = [
    {
      'heading': 'Currency Calls ',
      'content':
